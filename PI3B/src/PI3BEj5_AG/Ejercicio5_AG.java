...
public class Ejercicio5_AG {
	...
	public static void main(String[] args){
		...
		ValuesInRangeProblemAG<Integer,List<Integer>> p1 = DatosUniverso_AG
				.iniDatos("C:\\Users\\Jorlu\\Desktop\\WS\\ADDA\\PI3B\\ficheros\\PI3Ej5DatosEntrada");
		...
		System.out.println("Coste (suma de pesos de la solucion) = " + Math.abs(cr1.fitness()));
		System.out.println("Subconjuntos escogidos:");
		for(int i = 0; i<p1.getSolucion(cr1).size(); i++) {
			if(p1.getSolucion(cr1).get(i) == 1) {
				System.out.println(DatosUniverso_AG.universosDisponibles.get(i));
			}
		}
		System.out.println();
		...
		ValuesInRangeProblemAG<Integer,List<Integer>> p2 = DatosUniverso_AG
				.iniDatos("C:\\Users\\Jorlu\\Desktop\\WS\\ADDA\\PI3B\\ficheros\\PI3Ej5DatosEntrada2");
		...
		System.out.println("Coste (suma de pesos de la solucion) = " + Math.abs(cr2.fitness()));
